...
namespace FLS.ServerSide.EFCore.Entities
{
    public partial class FLSDbContext : DbContext
    {
        ...
        public virtual DbSet<StockIssueReceipt> StockIssueReceipt { get; set; }
        ...
        public virtual DbSet<StockReceivePaySlip> StockReceivePaySlip { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<StockIssueReceipt>(entity =>
            {
                entity.Property(e => e.Id)
                    .HasColumnName("id")
                    .HasColumnType("int(11)");
                ...
                entity.Property(e => e.StockIssueDocketId)
                    .HasColumnName("stock_issue_docket_id")
                    .HasColumnType("int(11)");
                entity.Property(e => e.StockIssueReceiptTypeId)
                    .HasColumnName("stock_issue_receipt_type_id")
                    .HasColumnType("int(11)");
                entity.Property(e => e.TotalAmount)
                    .HasColumnName("total_amount")
                    .HasColumnType("decimal(18,9)")
            ...
            modelBuilder.Entity<StockReceivePaySlip>(entity =>
            {
                entity.Property(e => e.Id)
                    .HasColumnName("id")
                    .HasColumnType("int(11)");
                ...
                entity.Property(e => e.IsDeleted)
                    .HasColumnName("is_deleted")
                    .HasColumnType("bit(1)");
                entity.Property(e => e.PayslipDate)
                    .HasColumnName("payslip_date")
                    .HasColumnType("datetime");
                entity.Property(e => e.StockReceiveDocketId)
                    .HasColumnName("stock_receive_docket_id")
                    .HasColumnType("int(11)");
                entity.Property(e => e.StockReceivePayslipTypeId)
                    .HasColumnName("stock_receive_payslip_type_id")
                    .HasColumnType("int(11)");
                entity.Property(e => e.SupplierBranchFullName)
                    .IsRequired()
                    .HasColumnName("supplier_branch_full_name")
                    .HasColumnType("varchar(200)");
                entity.Property(e => e.SupplierBranchId)
                    .HasColumnName("supplier_branch_id")
                    .HasColumnType("int(11)");
                entity.Property(e => e.SupplierBranchPhone)
                    .IsRequired()
                    .HasColumnName("supplier_branch_phone")
                    .HasColumnType("varchar(15)");
                entity.Property(e => e.TotalAmount)
                    .HasColumnName("total_amount")
                    .HasColumnType("decimal(18,9)")
