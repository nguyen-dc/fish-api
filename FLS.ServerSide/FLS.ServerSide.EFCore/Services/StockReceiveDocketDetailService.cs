...
namespace FLS.ServerSide.EFCore.Services
{
    public class StockReceiveDocketDetailService : IStockReceiveDocketDetailService
    {
        ...
        public async Task<int> Add(StockReceiveDocketDetail _model, bool _isSaveChange = true)
        {
        ...
        public async Task<bool> Modify(StockReceiveDocketDetail _model, bool _isSaveChange = true)
        {
