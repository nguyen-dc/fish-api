...
namespace FLS.ServerSide.EFCore.Services
{
    public class SupplierBranchService : ISupplierBranchService
    {
        ...
        public SupplierBranchService(FLSDbContext _context)
        {
            context = _context;
        }
        ...
        public async Task<int> Add(SupplierBranch _model, bool _isSaveChange = true)
        {
        ...
        public async Task<bool> Modify(SupplierBranch _model, bool _isSaveChange = true)
        {
        ...
        {
            SupplierBranch item = await context.SupplierBranch.Where(i => i.Id == _id && i.IsDeleted == true).FirstOrDefaultAsync();
