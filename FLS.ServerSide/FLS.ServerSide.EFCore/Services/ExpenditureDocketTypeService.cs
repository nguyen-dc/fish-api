...
namespace FLS.ServerSide.EFCore.Services
{
    public class ExpenditureDocketTypeService : IExpenditureDocketTypeService
    {
        ...
        public ExpenditureDocketTypeService(FLSDbContext _context, IScopeContext _scopeContext)
        {
            context = _context;
        ...
        public async Task<int> Add(ExpenditureDocketType _model)
        {
        ...
        public async Task<bool> Modify(ExpenditureDocketType _model)
        {
        ...
        {
            ExpenditureDocketType item = await context.ExpenditureDocketType.Where(i => i.Id == _id).FirstOrDefaultAsync();
