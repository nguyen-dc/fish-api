...
namespace FLS.ServerSide.EFCore.Services
{
    public class CustomerService : ICustomerService
    {
        ...
        public CustomerService(FLSDbContext _context)
        {
            context = _context;
        }
        ...
        public async Task<int> Add(Customer _model, bool _isSaveChange = true)
        {
        ...
        public async Task<bool> Modify(Customer _model, bool _isSaveChange = true)
        {
        ...
        {
            Customer item = await context.Customer.Where(i => i.Id == _id && i.IsDeleted == true).FirstOrDefaultAsync();
