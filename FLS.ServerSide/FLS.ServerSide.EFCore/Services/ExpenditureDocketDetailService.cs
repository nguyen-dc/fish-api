...
namespace FLS.ServerSide.EFCore.Services
{
    public class ExpenditureDocketDetailService : IExpenditureDocketDetailService
    {
        ...
        public async Task<int> Add(ExpenditureDocketDetail _model, bool _isSaveChange = true)
        {
        ...
        public async Task<bool> Modify(ExpenditureDocketDetail _model, bool _isSaveChange = true)
        {
