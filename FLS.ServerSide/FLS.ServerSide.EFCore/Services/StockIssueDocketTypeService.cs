...
namespace FLS.ServerSide.EFCore.Services
{
    public class StockIssueDocketTypeService : IStockIssueDocketTypeService
    {
        ...
        public async Task<int> Add(StockIssueDocketType _model, bool _isSaveChange = true)
        {
        ...
        public async Task<bool> Modify(StockIssueDocketType _model, bool _isSaveChange = true)
        {
