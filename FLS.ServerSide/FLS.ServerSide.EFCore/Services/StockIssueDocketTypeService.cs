...
namespace FLS.ServerSide.EFCore.Services
{
    public class StockIssueDocketTypeService : IStockIssueDocketTypeService
    {
        ...
        public StockIssueDocketTypeService(FLSDbContext _context, IScopeContext _scopeContext)
        {
            context = _context;
        ...
        {
            StockIssueDocketType item = await context.StockIssueDocketType.Where(i => i.Id == _id).FirstOrDefaultAsync();
